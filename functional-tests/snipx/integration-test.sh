...
function upload_code() {
    ...
    tx_hash="$(tx_of secretcli tx compute store "code/artifacts/$file.wasm.gz" ${FROM[a]} --gas 10000000)"
    code_id="$(
...
function main() {
    ...
    contract_addr="$(create_contract 'snipix' "$init_msg")"
